...
let dark_theme = {
    ...
    shape_external: red # commandes non trouvées (comme fish/zsh)
    shape_externalarg: green_bold
    shape_external_resolved: cyan # commandes valides
    shape_filepath: cyan
